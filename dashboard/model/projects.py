...
class Project(AuditMixin, CommonMixin, db.Model):
    ...
    crn_rdn_cpms_id: Mapped[int] = mapped_column(index=True, nullable=True)
    ...
    main_funding_industrial_collaboration_or_industry_id: Mapped[int] = mapped_column(ForeignKey(MainFundingIndustryCollaborationOrIndustry.id), index=True)
    main_funding_industrial_collaboration_or_industry: Mapped[MainFundingIndustryCollaborationOrIndustry] = relationship(foreign_keys=[main_funding_industrial_collaboration_or_industry_id])
